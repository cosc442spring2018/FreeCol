...
public class ColonizationMapLoader implements MapLoader {
    ...
    public Layer loadMap(Game game, Layer layer) {
        ...
        if (highestLayer == Layer.LAND) {
            ...
            improveRiver(game, spec, tiles, highestLayer, index, tileType);
        }
        return highestLayer;
    }

	private void improveRiver(Game game, Specification spec, Tile[][] tiles, Layer highestLayer, int index,
			TileType tileType) {
