...
public class DebugMenu extends JMenu {
    ...
    private void buildDebugMenu() {
        ...
        initSc(gui);
        initReveal(hasServer);
        initHide(hasServer);
        initSearchTrace(game);
        initCVPMenu(game, gui);
        this.addSeparator();
        initSkipTurns(hasServer);
        initAddBuilding(hasServer);
        initAddFather(hasServer);
        initRunMonarch(hasServer);
        initAddGold(hasServer);
        initAddCrosses(hasServer);
        initGiveBells(hasServer);
        initRng(hasServer);
        // Unit display
        ...
        du.setEnabled(true);
        this.addSeparator();
        initPanelMenu(gui, player);
        initEurope(hasServer);
        final JCheckBoxMenuItem dami = initDam(gui);
        initAi(gui, hasServer, dami);
        this.addSeparator();
        initCompareMaps(hasServer);
        initResourceKeys(gui);
        // statistics
        initStat(gui);
        // garbage collector
	...
	private void initStat(final GUI gui) {
	...
	private void initAi(final GUI gui, final boolean hasServer, final JCheckBoxMenuItem dami) {
	...
	private void initEurope(final boolean hasServer) {
	...
	private JCheckBoxMenuItem initDam(final GUI gui) {
	...
	private void initPanelMenu(final GUI gui, final Player player) {
	...
	private void initCompareMaps(final boolean hasServer) {
	...
	private void initResourceKeys(final GUI gui) {
	...
	private void initRng(final boolean hasServer) {
	...
	private void initGiveBells(final boolean hasServer) {
	...
	private void initAddCrosses(final boolean hasServer) {
	...
	private void initAddGold(final boolean hasServer) {
	...
	private void initRunMonarch(final boolean hasServer) {
	...
	private void initAddFather(final boolean hasServer) {
	...
	private void initAddBuilding(final boolean hasServer) {
	...
	private void initSkipTurns(final boolean hasServer) {
	...
	private void initCVPMenu(final Game game, final GUI gui) {
		final JMenu cvpMenu
	...
	private void initSearchTrace(final Game game) {
		// Search tracing
	...
	private void initHide(final boolean hasServer) {
	...
	private void initReveal(final boolean hasServer) {
	...
	private void initSc(final GUI gui) {
