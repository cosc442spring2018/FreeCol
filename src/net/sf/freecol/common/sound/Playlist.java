...
public final class Playlist {
	...
	public static final int FORWARDS = 0, // order of the sounds is determined by order in Playlist
			...
			SHUFFLE = 2; /**
 * Order of the sounds is randomly determined (each sound has the same chance of
							 * being picked, but eventually all sounds will be played as much as any other
							 * sound).
							 */
	 ...
	 * @param repeatMode
	 *            Determines how, which and if songs will be repeated. Should be one
	 *            of {PLAY_ALL, REPEAT_ALL, PLAY_ONE, REPEAT_ONE}.
	 * @param pickMode
	 *            The way in which sounds will be picked from the list. Should be
	 *            one of {FORWARDS, BACKWARDS, SHUFFLE}.
	 */
